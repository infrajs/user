<!--
http://www.seotoaster.com/e-commerce-privacy-terms-conditions-policy-free-template-generator.html
-->
<h1>Terms of service</h1>
<p>This Privacy Policy governs the manner in which {location.host}&nbsp;collects, uses, maintains and discloses information collected from users (each, a "User") of the {location.host}.net&nbsp;website ("Site"). This privacy policy applies to the Site and all products and services offered by {location.host}.</p>
...
<p>{location.host}&nbsp;collects and uses Users personal information for the following purposes:</p>
...
<p>{location.host}&nbsp;has the discretion to update this privacy policy at any time. When we do, revise the updated date at the bottom of this page,. We encourage Users to frequently check this page for any changes to stay informed about how we are helping to protect the personal information we collect. You acknowledge and agree that it is your responsibility to review this privacy policy periodically and become aware of modifications.</p>
<h2>Your acceptance of these terms</h2>

<p>By using this Site, you signify your acceptance of this policy and <a href="/user/terms">terms of service</a>. If you do not agree to this policy, please do not use our Site. Your continued use of the Site following the posting of changes to this policy will be deemed your acceptance of those changes.</p>